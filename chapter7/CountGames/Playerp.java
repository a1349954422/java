...
public class Playerp extends JPanel {
    ...
    private void initPlayPenal() {
        ...
        EmptyBorder eb = new EmptyBorder(new Insets(30,30,5,30));
        ...
        EmptyBorder eb2 = new EmptyBorder(new Insets(30,30,5,30));
        diffP.setBorder(eb2);
     ...
     class MyActionListner implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if(e.getSource() == numComboBox){
                ...
                board.setNums((String)numComboBox.getSelectedItem());
            }else if(e.getSource() == diffComboBox){
                numComboBox.setEnabled(false);
                diffComboBox.setEnabled(false);
                inputAnswer.setEnabled(true);
                board.setDiff((String)diffComboBox.getSelectedItem());
                board.initGame();
                inputAnswer.setText("");
